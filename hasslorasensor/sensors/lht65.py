...
class LHT65NSensor(LoraMqttSensor):
    def __init__(self) -> None:
        super().__init__()

        self.measurements = {
            "battery_voltage": Measurement(id="BatV", device_class=DeviceClass.VOLTAGE),
            "internal_temp_sensor": Measurement(id="TempC_SHT", device_class=DeviceClass.TEMPERATURE),
            "external_temp_sensor": Measurement(id="TempC_DS", device_class=DeviceClass.TEMPERATURE),
